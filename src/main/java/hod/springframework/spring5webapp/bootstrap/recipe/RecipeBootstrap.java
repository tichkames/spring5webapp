package hod.springframework.spring5webapp.bootstrap.recipe;

import hod.springframework.spring5webapp.model.recipe.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        log.debug("Running RecipeBootstrap");
        ...
        //was needed for bidirectional mapping
